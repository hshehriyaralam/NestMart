...
const TimeBox = ({ value, label }: { value: string; label: string }) => (
  <div className="bg-white rounded-xl px-2 py-6 text-center shadow w-14 h-20 flex flex-col items-center justify-center">
    <p className="text-green-500 font-quicksand font-medium text-xl leading-none">{value}</p>
  ...
  return (
    <div className="max-w-full h-full mb-16">
      ...
      <div className="p-2 flex flex-col ">
        ...
        <p>
          ⭐⭐ <span className="font-lato text-regular">(4.0)</span>
        </p>
        <p className="text-accent font-lato mb-auto">
          By <span className="text-primary font-lato"> NestFood</span>
        </p>
        <div className="flex items-center justify-between py-1.5 mt-auto">
          <div>
            <span className="font-heading-1_0 text-primary">
              $<span className="font-heading-1_0 text-primary">1300</span>
            </span>{" "}
