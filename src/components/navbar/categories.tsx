      ...
      <div className="max-w-[92%] mx-auto flex items-center justify-between  ">
        ...
        <div className="lg:flex items-center p-4 gap-4">
          ...
          >
            ...
            <span className="font-quicksand text-primary font-medium text-xs">
              Your Location
            </span>
          ...
          <div className="flex gap-4">
            <button className="flex items-end">
              ...
              <span className="action-button-text text-sm font-medium pl-2">compare</span>
            </button>

            <button className="flex items-end">
              <Heart className="action-button" />
              <span className="action-button-text text-sm font-medium pl-2">Wishlist</span>
            </button>

            <button className="flex items-end">
              <ShoppingCart className="action-button" />
              <span className="action-button-text text-sm font-medium pl-2">Cart</span>
            </button>

            <button className="flex items-end">
              <User className="action-button" />
              <span className="action-button-text text-sm font-medium pl-2">Account</span>
            </button>
          </div>
        </div>
      </div>
