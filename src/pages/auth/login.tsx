    ...
    <div  className='w-[40%]   p-8  ' >
      <div  className='p-6  '>
        ...
        <div className=' p-6 flex flex-col gap-y-3 ' >
          <p  className='font-quicksand   text-secondary  text-sm '>Welcome back !! </p>
          <h2 className='font-heading text-4xl' >Sign in</h2>
          ...
          <p  className='font-quicksand  text-accent text-[14px] text-center mt-4'>
            I don't have an account?
             <a href="/auth/signup" className="text-primary  font-semibold"> Sign up</a>
             </p>
          </form>
